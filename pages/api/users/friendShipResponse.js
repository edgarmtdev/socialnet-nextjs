    ...
    if (accepted) {
      await client.user.update({
        ...
        data: {
          ...
          friendshipReqSendIDs: friend.friendshipReqSendIDs.filter(
            (id) => id != idUser
          ),
        },
      });
      ...
      newUser = await client.user.update({
        ...
        data: {
          ...
          friendshipReqRecIDs: user.friendshipReqRecIDs.filter(
            (id) => id != idFriend
          ),
        },
        include: {
      ...
      where: {
        id: {
          notIn: [
            idUser,
            ...newUser.friendsIDs,
            ...newUser.friendshipReqRecIDs,
            ...newUser.friendshipReqSendIDs,
          ],
        },
      },
    });
